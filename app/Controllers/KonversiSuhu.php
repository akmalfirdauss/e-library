...
class KonversiSuhu extends BaseController
{
    ...
    public function list()
    {
        ...
        $list = $this->KonversiSuhuModel->select('konversi_suhu.id, konversi_suhu.suhu, konversi_suhu.kondisi, 
        satuan_suhu.nama AS satuan')->join('satuan_suhu', 'konversi_suhu.satuan_id = satuan_suhu.id')->findAll();
    ...
    public function insert_save()
    {
        ...
        return redirect()->to('konversi_suhu');
    }
